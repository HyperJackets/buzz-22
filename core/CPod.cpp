...
//Note that the following methods (load, launch, brake, crawl) will only be called by CPod's step method when its state machine is in certain states.
//Here we will have code that works with the hardware, motor, braking, propulsion, etc.
void CPod::load(void)
{
